...
async function contactlessCaptureLaterTest() {
  ...
  card.track = ";4761739001010036=25122011184404889?";
  card.tag =
  ...
  card.paymentOption.entryMode = EntryMode.CONTACTLESS_CHIP;

  const response = await card
    .charge("12000")
    .withAccountName("Transaction_Processing")
    .withCapture({ mode: "LATER" })
    .withCountry("US")
    .withChannel("CP")
